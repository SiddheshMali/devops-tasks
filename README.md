...
A comprehensive guide for setting up a Kubernetes cluster using Kind on an AWS EC2 Ubuntu instance, installing and configuring Argo CD, and deploying applications using Argo CD.
